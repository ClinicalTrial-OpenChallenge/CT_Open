...
One issue: because Markdown code blocks cannot be nested cleanly inside one big Markdown code block, the above may break when copied. Use this safer version with `~~~` fences:
